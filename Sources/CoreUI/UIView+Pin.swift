...
extension UIView {
    ...
    /// - Returns: The applied constraints
    @discardableResult
    public func pinToCenter(of view: UIView? = nil) -> (horizontal: NSLayoutConstraint, vertical: NSLayoutConstraint) {
    ...
    /// - Returns: The applied constraint
    @discardableResult
    public func centerHorizontally(of view: UIView? = nil) -> NSLayoutConstraint {
        if let view = view {
    ...
    /// - Returns: The applied constraint
    @discardableResult
    public func centerVertically(of view: UIView? = nil) -> NSLayoutConstraint {
        if let view = view {
